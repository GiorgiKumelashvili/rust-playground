...
fn deserialize_from_string(input: &str, format: Format) -> Result<Vec<Record>, ConversionError> {
...
fn serialize_to_string(records: &[Record], format: Format) -> Result<String, ConversionError> {
    match format {
        Format::Json => {
